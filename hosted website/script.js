...
<hr style="border: 1px solid black;"/>
        ...
        <h3 style="margin: 2px 0; display: inline-block; border-bottom: 2px solid black; padding-bottom: 5px;">Seminar-Group Discussion Report (Assignment-${assignmentNo})</h3>
...
<br>
  ...
  <h3 style="margin: 0; font-size: 29px;white-space:nowrap;">
...
function downloadPdf() {
  ...
  html2canvas(element, {
    useCORS: true,
    scale: 2 // reduces resolution to reasonable level
  }).then((canvas) => {
    const imgData = canvas.toDataURL("image/jpeg", 0.7); // compress JPEG at 70% quality
    ...
    pdf.addImage(imgData, 'JPEG', 0, 0, pdfWidth, imgHeight, '', 'FAST');
